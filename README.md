...
These commands are available from the command line after installing `jtmethtools`. They are designed for common tasks that don't require custom scripting, or for use in pipelines.

| Command                      | What it does                                                                                                                                                                                      |
|------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `jtm-write-methylation-data` | BAM → parquet methylation dataset                                                                                                                                                                 |
| `jtm-filter-mCH`             | Write a new BAM with methylated CpH reads removed                                                                                                                                                 |
...
A container for Arrow backed DataFrames. 
